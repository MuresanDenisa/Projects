...
public class AddFurnizorView extends JFrame {

	private static final long serialVersionUID = 1L;
	private JButton addFurnizorBtn = new JButton("Finalizare");
	private JButton resetBtn = new JButton("Resetare");
	private JButton backBtn = new JButton("Back");
	private JTextField idFurnizor = new JTextField(12);
	private JTextField denumire = new JTextField(14);
	...
	public AddFurnizorView() {
		...
		idFurnizor.setEditable(false);

		JPanel panel1 = new JPanel();
		panel1.setBackground(new Color(51, 153, 255));
		JLabel label = new JLabel("Va rugam introduceti detaliile furnizorului: ", SwingConstants.CENTER);
		...
		JLabel label1 = new JLabel("Id furnizor:", SwingConstants.CENTER);
		label1.setFont(new Font("Serif", Font.BOLD, 20));
		panel2.add(label1);
		panel2.add(idFurnizor);

		JPanel panel3 = new JPanel();
		panel3.setBackground(new Color(51, 153, 255));
		panel3.setLayout(new FlowLayout());
		JLabel label2 = new JLabel("Furnizor:", SwingConstants.CENTER);
		...
		this.pack();
		this.setTitle("Adaugare Furnizor");
	...
	public void setId(int id) {
		this.idFurnizor.setText("" + id);
	}

	public int getId() {
		return Integer.valueOf(this.idFurnizor.getText());
	}
	...
	public void addFurnizorListener(ActionListener listenForFurnizor) {
		addFurnizorBtn.addActionListener(listenForFurnizor);
	}
